...
export interface ApiBannerCollectionBannerCollection
  extends Schema.CollectionType {
  collectionName: 'banner_collections';
  info: {
    singularName: 'banner-collection';
    pluralName: 'banner-collections';
    displayName: 'BannerCollection';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    BannerImg: Attribute.Media<'images' | 'videos', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::banner-collection.banner-collection',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiCardContentHomePageCardContentHomePage
  ...
  info: {
    singularName: 'card-content-home-page';
    pluralName: 'card-content-home-pages';
    displayName: 'CardContentHomePage';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    IconLogo: Attribute.Media<'images' | 'videos'> & Attribute.Required;
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::card-content-home-page.card-content-home-page',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomePageTopContentHomePageTopContent
  extends Schema.SingleType {
  collectionName: 'home_page_top_contents';
  info: {
    singularName: 'home-page-top-content';
    pluralName: 'home-page-top-contents';
    displayName: 'HomePageTopContent';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMerchantLogoCollectionMerchantLogoCollection
  extends Schema.CollectionType {
  collectionName: 'merchant_logo_collections';
  info: {
    singularName: 'merchant-logo-collection';
    pluralName: 'merchant-logo-collections';
    displayName: 'MerchantLogoCollection';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    MerchantLogos: Attribute.Media<'images'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::merchant-logo-collection.merchant-logo-collection',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSpotlightBlogSpotlightBlog extends Schema.CollectionType {
  ...
  info: {
    singularName: 'spotlight-blog';
    pluralName: 'spotlight-blogs';
    displayName: 'SpotlightBlog';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::spotlight-blog.spotlight-blog',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiUserFeedbackCollectionUserFeedbackCollection
  extends Schema.CollectionType {
  collectionName: 'user_feedback_collections';
  info: {
    singularName: 'user-feedback-collection';
    pluralName: 'user-feedback-collections';
    displayName: 'UserFeedbackCollection';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    UserImg: Attribute.Media<'images'>;
    Name: Attribute.String & Attribute.Required;
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::user-feedback-collection.user-feedback-collection',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
